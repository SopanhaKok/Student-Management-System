<?php 
    ...
    if(isset($_POST['deleteClass'])){
        ...
        try{
            ...
            $delete->execute();
            $_SESSION['success'] = 'Class was deleted successfully';
            header('Location: manage_classes.php');
        }catch(PDOException $e){
            $_SESSION['error'] = 'Class was not deleted';
            header('Location: manage_classes.php');
        }
    }
...
<div class="content-wrapper">
    ...
    <div class="container">
        ...
        <div class="container col-lg-6 student-container bg-light p-4 mb-3">
            ...
            <form class="mt-4" action="delete_class.php" method="POST">
                <p>Are you sure you want to delete this class ?</p>
                <div class="form-group d-flex justify-content-between">
                    <input type="hidden" name="id" value="<?php echo $id ?>">
                    <a class="btn btn-primary" href="manage_classes.php">Back</a>
                    <input class="btn btn-danger" type="submit" name="deleteClass" value="Delete">
                </div>
            </form>
        </div>
    </div>
