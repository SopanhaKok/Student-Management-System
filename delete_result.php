<?php 
    ...
    if(isset($_GET['id'])){
        $id = $_GET['id'];
        $stmt = $conn->prepare('SELECT * FROM results WHERE student_id = :id');
    ...
    if(isset($_POST['deleteResult'])){
        ...
        try{
            ...
            $delete->execute();
            $_SESSION['success'] = 'Result was deleted successfully';
            header('Location: manage_results.php');
        }catch(PDOException $e){
            $_SESSION['error'] = 'Result was not deleted';
            header('Location: manage_results.php');
        }
    }
...
<div class="content-wrapper">
    ...
    <div class="container">
        <div class="container col-lg-6 student-container bg-light p-4 mb-3">
            ...
            <form class="mt-4" action="delete_result.php" method="POST">
                <p>Are you sure you want to delete this result ?</p>
                <div class="form-group d-flex justify-content-between">
                    <input type="hidden" name="id" value="<?php echo $id ?>">
                    <a class="btn btn-primary" href="manage_results.php">Back</a>
                    <input class="btn btn-danger" type="submit" name="deleteResult" value="Delete">
                </div>
            </form>
        </div>
    </div>
