    ...
    <div class="container">
        ...
        <div class="container col-lg-6 manage-student-container bg-light p-4 mb-3">
            <div class="d-flex justify-content-between mb-5">
                <div class="h4">Students Details</div>
                <a class="btn btn-success" href="add_student.php">Add New Student</a>
            </div>
            <table class="table table-bordered">
                ...
                <tbody>
                    <?php
                        $stmt = $conn->query("SELECT *,classes.className AS className FROM students INNER JOIN classes ON classes.id = students.class_id");
                        $i = 1;
                        while($row = $stmt->fetch(PDO::FETCH_ASSOC)){
                            ...
                            echo "<td>
                                <a class='mr-2' href='edit_student.php?id=".$row['studentId']."'><i class='fas  fa-pencil-alt'></i></a>
                                <a class='mr-2' href='delete_student.php?id=".$row['studentId']."'><i class='fas fa-trash-alt'></i></a>
                            </td>";
                            $i++;
                        }
                    ?>
